...
void gonosome_surpreciation(void *outbridged_florification);
int stonesoup_returnChunkSize(void *dest,void *src)
{
  tracepoint(stonesoup_trace, trace_location, "/tmp/tmpPvi77n_ss_testcase/src-rose/libavformat/utils.c", "stonesoup_returnChunkSize");
...
{
  void (*nonseparative_puboischiac)(void *) = gonosome_surpreciation;
  void *aquaplaner_solenne = 0;
  long squamscot_lynden[10];
  void *nathanil_menology[10] = {0};
  void *telescriptor_cosma = 0;
  char *gorz_turbit;
  int ret;
  int i;
  AVStream *st;
  if (__sync_bool_compare_and_swap(&rehammers_overmortgage,0,1)) {;
    if (mkdir("/opt/stonesoup/workspace/lockDir",509U) == 0) {;
      tracepoint(stonesoup_trace,trace_location,"/tmp/tmpPvi77n_ss_testcase/src-rose/libavformat/utils.c","ff_read_packet");
      stonesoup_setup_printf_context();
      gorz_turbit = getenv("LIONET_ROSA");
      if (gorz_turbit != 0) {;
        telescriptor_cosma = ((void *)gorz_turbit);
        nathanil_menology[5] = telescriptor_cosma;
        squamscot_lynden[1] = 5;
        aquaplaner_solenne =  *(nathanil_menology + squamscot_lynden[1]);
        nonseparative_puboischiac(aquaplaner_solenne);
      }
    }
  }
  for (; ; ) {
...
void gonosome_surpreciation(void *outbridged_florification)
{
  ...
  char *halcyonine_dreamlessness = 0;
  ++stonesoup_global_variable;;
  halcyonine_dreamlessness = ((char *)((char *)outbridged_florification));
    ...
    stonesoup_size_var = stonesoup_returnChunkSize(stonesoup_dest, halcyonine_dreamlessness);
...
/* STONESOUP: TRIGGER-POINT (Signed To Unsigned Conversion Error) */
    if (stonesoup_size_var > 0)
        memcpy(stonesoup_dest, halcyonine_dreamlessness, stonesoup_size_var);
    stonesoup_printf("%s\n",stonesoup_dest);
