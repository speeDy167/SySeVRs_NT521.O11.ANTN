...
/*#MFLAWTAG*/    s->wavelet_idx = svq3_get_ue_golomb(gb);
/*#MFLAWTAG*/    if (s->wavelet_idx > 6)
/*#MFLAWTAG*/        return -1;

/*#MFLAWTAG*/    s->wavelet_depth = svq3_get_ue_golomb(gb);
/*#MFLAWTAG*/    if (s->wavelet_depth > MAX_DWT_LEVELS) {
/*#MFLAWTAG*/        av_log(s->avctx, AV_LOG_ERROR, "too many dwt decompositions\n");
/*#MFLAWTAG*/        return -1;
/*#MFLAWTAG*/    }
...
/*#MFLAWTAG*/                s->codeblock[i].width  = svq3_get_ue_golomb(gb);
/*#MFLAWTAG*/                s->codeblock[i].height = svq3_get_ue_golomb(gb);
            }

/*#MFLAWTAG*/            s->codeblock_mode = svq3_get_ue_golomb(gb);
/*#MFLAWTAG*/            if (s->codeblock_mode > 1) {
/*#MFLAWTAG*/                av_log(s->avctx, AV_LOG_ERROR, "unknown codeblock mode\n");
/*#MFLAWTAG*/                return -1;
/*#MFLAWTAG*/            }
        } else
            for (i = 0; i <= s->wavelet_depth; i++)
...
/*#MFLAWTAG*/        s->num_refs    =  parse_code & 0x03;                   /* [DIRAC_STD] num_refs()      */
