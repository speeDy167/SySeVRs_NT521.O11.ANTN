...
{
/*#MFLAWTAG*/  char              domain_name_unicode[256];
/*#MFLAWTAG*/  char              user_uppercase[256];
/*#MFLAWTAG*/  char              buf[512];
  /*guint8 md4[NTLMSSP_KEY_LEN];*/
  unsigned char     nt_password_hash[NTLMSSP_KEY_LEN];
...
#endif
  i = 0;
/*#MFLAWTAG*/  memset(user_uppercase, 0, 256);
  user_len = strlen(ntlmssph->acct_name);
/*#MFLAWTAG*/  if (user_len < 129) {
/*#MFLAWTAG*/    memset(buf, 0, 512);
...
/*#MFLAWTAG*/    memset(buf, 0, 512);
    memcpy(buf, serverchallenge, 8);
/*#MFLAWTAG*/    memcpy(buf+8, ntlm_response->contents+NTLMSSP_KEY_LEN, ntlm_response->length-NTLMSSP_KEY_LEN);
