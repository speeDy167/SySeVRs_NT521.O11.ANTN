...
/*#MFLAWTAG*/        f->chroma_planes  = get_rac(c, state);
/*#MFLAWTAG*/        f->chroma_h_shift = get_symbol(c, state, 0);
/*#MFLAWTAG*/        f->chroma_v_shift = get_symbol(c, state, 0);
/*#MFLAWTAG*/        f->transparency   = get_rac(c, state);
        f->plane_count    = 2 + f->transparency;
    }
