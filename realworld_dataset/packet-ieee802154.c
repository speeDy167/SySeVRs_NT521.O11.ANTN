...
/*#MFLAWTAG*/        g_hash_table_insert(au_ieee802154_map->short_table, &old_key, p_map_rec);
    } else {
...
/*#MFLAWTAG*/        g_hash_table_insert(au_ieee802154_map->long_table, &old_key, p_map_rec);
    } else {
        /* create new hash entry */
