 ...
 *
 * $Id: packet-assa_r3.c 49748 2013-06-04 02:47:14Z morriss $
 *
...
/*#MFLAWTAG*/  for (i = 0; i < len; i += tvb_get_guint8 (tvb, i))
  {
...
/*#MFLAWTAG*/  for (i = 0; i < len; i += tvb_get_guint8 (tvb, start_offset + i))
  {
