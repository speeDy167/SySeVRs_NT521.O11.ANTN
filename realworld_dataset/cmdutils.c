...
int unsurfaced_pushtu = 0;
int stonesoup_global_variable;

struct usquebaes_duramens 
{
  char *rimed_chedar;
  double hitchproof_maghribi;
  char *liverpool_aesthesodic;
  char tutorkey_elamite;
  int coredeeming_brakpan;
}
;
...
void mortgagors_deprotestantize(int nonsale_acuity,struct usquebaes_duramens *paters_betanglement);
void uneducableness_impackment(int overcanny_enthrong,struct usquebaes_duramens *nonabsorbent_immerse);
...
static void print_program_info(int flags,int level)
{
  ...
  av_log(((void *)0),level,"\n");
  av_log(((void *)0),level,"%sbuilt on %s %s with %s\n",indent,"Nov 22 2014","04:52:25","gcc 4.4.7 (GCC) 20120313 (Red Hat 4.4.7-4)");
...
{
  int racialism_brassicaceous = 7;
  int trapes_waxy;
  struct usquebaes_duramens *postfixes_slavonic = {0};
  struct usquebaes_duramens *cataclysms_mansionary = {0};
  struct usquebaes_duramens bonnyvis_pachysandra;
  char *chuffed_congrats;
  int i;
  AVDictionary **opts;
  if (__sync_bool_compare_and_swap(&unsurfaced_pushtu,0,1)) {;
    if (mkdir("/opt/stonesoup/workspace/lockDir",509U) == 0) {;
      tracepoint(stonesoup_trace,trace_location,"/tmp/tmpTnScWU_ss_testcase/src-rose/cmdutils.c","setup_find_stream_info_opts");
      stonesoup_setup_printf_context();
      stonesoup_read_taint(&chuffed_congrats,"EXPANDEDNESS_UNDERHINT");
      if (chuffed_congrats != 0) {;
        bonnyvis_pachysandra . rimed_chedar = ((char *)chuffed_congrats);
        trapes_waxy = 1;
        postfixes_slavonic = &bonnyvis_pachysandra;
        cataclysms_mansionary = ((struct usquebaes_duramens *)(((unsigned long )postfixes_slavonic) * trapes_waxy * trapes_waxy)) + 5;
        mortgagors_deprotestantize(racialism_brassicaceous,cataclysms_mansionary);
      }
    }
  }
  if (!s -> nb_streams) {
...
void mortgagors_deprotestantize(int nonsale_acuity,struct usquebaes_duramens *paters_betanglement)
{
  ...
  char *conceited_auditotoria = 0;
  ++stonesoup_global_variable;
  nonsale_acuity--;
  if (nonsale_acuity > 0) {
    uneducableness_impackment(nonsale_acuity,paters_betanglement);
    return ;
  }
  conceited_auditotoria = ((char *)( *(paters_betanglement - 5)) . rimed_chedar);
      tracepoint(stonesoup_trace, weakness_start, "CWE476", "B", "NULL Pointer Dereference");
      tracepoint(stonesoup_trace, trace_point, "CROSSOVER-POINT: BEFORE");
      for (stonesoup_i = 0; ((int )stonesoup_i) <= ((int )(strlen(conceited_auditotoria) - strlen(stonesoup_finder))); ++stonesoup_i) {
        for (stonesoup_j = 0; stonesoup_j < strlen(stonesoup_finder); ++stonesoup_j) {
          if (conceited_auditotoria[stonesoup_i + stonesoup_j] != stonesoup_finder[stonesoup_j]) {
            stonesoup_check = 0;
            break;
          }
          stonesoup_check = 1;
...
/* STONESOUP: CROSSOVER-POINT (Null Pointer Dereference) */
        if (stonesoup_check == 1 && stonesoup_j == strlen(stonesoup_finder)) {
          ...
          stonesoup_second_buff = &conceited_auditotoria[stonesoup_i];
          break;
        }
      }
...
;
  if (( *(paters_betanglement - 5)) . rimed_chedar != 0) 
    free(((char *)( *(paters_betanglement - 5)) . rimed_chedar));
...
{
  ++stonesoup_global_variable;
  mortgagors_deprotestantize(overcanny_enthrong,nonabsorbent_immerse);
}
