...
/*#MFLAWTAG*/    wccp_wccp_address_table.in_use = TRUE;
...
/*#MFLAWTAG*/      if ((wccp_wccp_address_table.table_ipv4 != NULL) && ((address_length * i) < wccp_wccp_address_table.table_length))
        wccp_wccp_address_table.table_ipv4[i] = tvb_get_ntohl(tvb, offset);
      break;
    case 2:
      /* IPv6 */
      addr = tvb_ip6_to_str(tvb, offset);
/*#MFLAWTAG*/      if ((wccp_wccp_address_table.table_ipv6 != NULL) && ((address_length * i) < wccp_wccp_address_table.table_length))
    ...
    if (element_tree) {
      ...
      pi = proto_tree_add_string_format_value(element_tree, hf_address_table_element, tvb,
                                              ...
                                              "%d: %s", i+1, addr);
/*#MFLAWTAG*/      if ((address_length * i) > wccp_wccp_address_table.table_length)
