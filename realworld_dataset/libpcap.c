...
/*#MFLAWTAG*/	if (hdr->hdr.orig_len > WTAP_MAX_PACKET_SIZE) {
/*#MFLAWTAG*/		/*
/*#MFLAWTAG*/		 * Probably a corrupt capture file; return an error,
/*#MFLAWTAG*/		 * so that our caller doesn't blow up trying to
/*#MFLAWTAG*/		 * cope with a huge "real" packet length, and so that
/*#MFLAWTAG*/		 * the code to try to guess what type of libpcap file
/*#MFLAWTAG*/		 * this is can tell when it's not the type we're guessing
/*#MFLAWTAG*/		 * it is.
/*#MFLAWTAG*/		 */
/*#MFLAWTAG*/		*err = WTAP_ERR_BAD_FILE;
/*#MFLAWTAG*/		if (err_info != NULL) {
/*#MFLAWTAG*/			*err_info = g_strdup_printf("pcap: File has %u-byte packet, bigger than maximum of %u",
/*#MFLAWTAG*/			    hdr->hdr.orig_len, WTAP_MAX_PACKET_SIZE);
/*#MFLAWTAG*/		}
/*#MFLAWTAG*/		return -1;
	}
...
/*#MFLAWTAG*/	if (rec_hdr.hdr.incl_len > WTAP_MAX_PACKET_SIZE || rec_hdr.hdr.orig_len > WTAP_MAX_PACKET_SIZE) {
		*err = WTAP_ERR_BAD_FILE;
		return FALSE;
	}
