 ...
 *
 * $Id: packet-dcom-sysact.c 48685 2013-04-01 15:29:49Z jake $
 *
...
/*#MFLAWTAG*/    DISSECTOR_ASSERT(pg->id_idx < MAX_ACTPROP_LIMIT);
/*#MFLAWTAG*/    offset = dissect_dcom_UUID(tvb, offset, pinfo, tree, drep,
/*#MFLAWTAG*/                        hf_sysact_actpropclsid, &pg->guid[pg->id_idx++]);
...
/*#MFLAWTAG*/    DISSECTOR_ASSERT(pg->size_idx < MAX_ACTPROP_LIMIT);
/*#MFLAWTAG*/    offset = dissect_dcom_DWORD(tvb, offset, pinfo, tree, drep,
/*#MFLAWTAG*/                        hf_sysact_actpropsize, &pg->size[pg->size_idx++]);
        ...
        proto_tree *tree, guint8 *drep, gint size _U_)
{
    ...
    di = (dcerpc_info *)pinfo->private_data;
/*#MFLAWTAG*/    if (di->private_data) {
/*#MFLAWTAG*/        g_free(di->private_data);
/*#MFLAWTAG*/    }
/*#MFLAWTAG*/    di->private_data = g_new(property_guids_t,1);
/*#MFLAWTAG*/    memset(di->private_data, 0, sizeof(property_guids_t));
