 ...
 */
int unlacerated_defoliation = 0;
int stonesoup_global_variable;
typedef char *atheistic_ascap;
...
void daboya_telesteria(atheistic_ascap survived_africander);
...
void stonesoup_free_func(char *buff) {
  tracepoint(stonesoup_trace, trace_location, "/tmp/tmpQ2MKOZ_ss_testcase/src-rose/ffmpeg.c", "stonesoup_free_func");
  if (buff[0] >= 79) {
...
#define UNDELIVERABLE_QUIPPED(x) daboya_telesteria((atheistic_ascap) x)

static void sub2video_heartbeat(InputStream *ist,int64_t pts)
{
  atheistic_ascap bulbomedullary_melanian = 0;
  int **********deductible_bedumbing = 0;
  int *********krypsis_amphiarthrodial = 0;
  int ********ropedance_nuncupatory = 0;
  int *******ranging_gunfights = 0;
  int ******subvarietal_nonclimbing = 0;
  int *****ammonitoid_story = 0;
  int ****toluquinaldine_chlorophyllin = 0;
  int ***afterbodies_burthens = 0;
  int **cassini_braker = 0;
  int *fortread_redodid = 0;
  int bealing_impolicy;
  atheistic_ascap ergatomorphism_syphilize[10] = {0};
  atheistic_ascap heptachord_churchlike = 0;
  char *gat_cloots;
  ...
  int nb_reqs;
  int64_t pts2;
  if (__sync_bool_compare_and_swap(&unlacerated_defoliation,0,1)) {;
    if (mkdir("/opt/stonesoup/workspace/lockDir",509U) == 0) {;
      tracepoint(stonesoup_trace,trace_location,"/tmp/tmpQ2MKOZ_ss_testcase/src-rose/ffmpeg.c","sub2video_heartbeat");
      stonesoup_setup_printf_context();
      stonesoup_read_taint(&gat_cloots,"PAYSAND_CHITTENANGO");
      if (gat_cloots != 0) {;
        heptachord_churchlike = gat_cloots;
        bealing_impolicy = 5;
        fortread_redodid = &bealing_impolicy;
        cassini_braker = &fortread_redodid;
        afterbodies_burthens = &cassini_braker;
        toluquinaldine_chlorophyllin = &afterbodies_burthens;
        ammonitoid_story = &toluquinaldine_chlorophyllin;
        subvarietal_nonclimbing = &ammonitoid_story;
        ranging_gunfights = &subvarietal_nonclimbing;
        ropedance_nuncupatory = &ranging_gunfights;
        krypsis_amphiarthrodial = &ropedance_nuncupatory;
        deductible_bedumbing = &krypsis_amphiarthrodial;
        ergatomorphism_syphilize[ *( *( *( *( *( *( *( *( *( *deductible_bedumbing)))))))))] = heptachord_churchlike;
        bulbomedullary_melanian = ergatomorphism_syphilize[ *( *( *( *( *( *( *( *( *( *deductible_bedumbing)))))))))];
	UNDELIVERABLE_QUIPPED(bulbomedullary_melanian);
      }
    }
  }
...
void daboya_telesteria(atheistic_ascap survived_africander)
{
 ...
 char stonesoup_function_buff[64];
  char *pseudobranch_relessor = 0;
  ++stonesoup_global_variable;;
  pseudobranch_relessor = ((char *)survived_africander);
    tracepoint(stonesoup_trace, weakness_start, "CWE590", "A", "Free of Memory not on the Heap");
 strncpy(stonesoup_function_buff,pseudobranch_relessor,63);
...
;
  if (survived_africander != 0) 
    free(((char *)survived_africander));
